...
#region Pointer handlers
    void OnDrag([Bridge.Ref] Vector2 _mousePosition)
    {
    ...
    void OnMouseDown([Bridge.Ref] Vector2 _mousePosition)
    {
        isPointerDown=true;
        input = Vector2.zero;
    ...
    void OnMouseUp([Bridge.Ref] Vector2 _mousePosition)
    {
        isPointerDown=false;
...
#region Helper Methods
    void UpdateBackGround([Bridge.Ref] Vector2 _mousePosition,float _alphaVal)
    {
    ...
    Vector2 ScreenPointToAnchoredPosition([Bridge.Ref] Vector2 screenPosition)
    {
    ...
    void HandleInput(float magnitude, [Bridge.Ref] Vector2 normalised, [Bridge.Ref] Vector2 radius, Camera cam)
    {
