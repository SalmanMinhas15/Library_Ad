...
if ( TRACE ) { TRACE( "AudioManager#Start", this ); }
            ...
            PlayBG: function () {
if ( TRACE ) { TRACE( "AudioManager#PlayBG", this ); }

                this.bgAS.Play();
            },
            /*AudioManager.PlayBG end.*/
